...
// funtion declaration-- This is a way of creating or delating function in javascript
function helloJuliet() {
  console.log("Hi Anne, Good Morning");
}

helloJuliet();

function meetJuliet(){
  console.log("Nice to meet u miss juliet");
...
function introduce(name, age, hobby){
  console.log(`my name is ${name} and i am ${age} years old! and i love ${hobby}`);
}

introduce("Juliet", 20, "Coding")



// Funtions that returns a value
function add(a, b){
  return a + b;
}
